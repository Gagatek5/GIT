(function() {
  ...
  addNo3dTransform = function() {
    docElement.className = docElement.className.replace('jest3d', '');
    return docElement.className += ' brak3d';
  };
  add3dTransform = function() {
    docElement.className = docElement.className.replace('brak3d', '');
    return docElement.className += ' jest3d';
  };
  addNo3dTransform();
